...
type Node struct {
	...
	ClusterId         int64      `protobuf:"varint,14,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`                            // @gotags: gorm:"column:cluster_id; default:0; NOT NULL"
	NodeGroupId       string     `protobuf:"bytes,15,opt,name=node_group_id,json=nodeGroupId,proto3" json:"node_group_id,omitempty"`                     // @gotags: gorm:"column:node_group_id; default:''; NOT NULL"
	ErrorInfo         NodeError  `protobuf:"varint,16,opt,name=error_info,json=errorInfo,proto3,enum=biz.cluster.NodeError" json:"error_info,omitempty"` // @gotags: gorm:"column:error_info; default:''; NOT NULL"
}
...
var file_internal_biz_cluster_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x64, 0x22, 0x9d, 0x04, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x64, 0x61, 0x74,
	0x61, 0x44, 0x69, 0x73, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63,
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0e,
