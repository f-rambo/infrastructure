...
type Node struct {
	...
	ErrorInfo         NodeError  `protobuf:"varint,18,opt,name=error_info,json=errorInfo,proto3,enum=biz.cluster.NodeError" json:"error_info,omitempty"` // @gotags: gorm:"column:error_info; default:''; NOT NULL"
}
