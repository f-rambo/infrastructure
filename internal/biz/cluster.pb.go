...
type Node struct {
	...
	NodeGroupId string     `protobuf:"bytes,9,opt,name=node_group_id,json=nodeGroupId,proto3" json:"node_group_id,omitempty"` // @gotags: gorm:"column:node_group_id; default:''; NOT NULL"
	InstanceId  string     `protobuf:"bytes,10,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"`     // @gotags: gorm:"column:instance_id; default:''; NOT NULL"
	ErrorInfo   string     `protobuf:"bytes,11,opt,name=error_info,json=errorInfo,proto3" json:"error_info,omitempty"`        // @gotags: gorm:"column:error_info; default:''; NOT NULL"
}
...
var file_internal_biz_cluster_proto_rawDesc = []byte{
	...
	0x48, 0x41, 0x52, 0x44, 0x5f, 0x44, 0x49, 0x53, 0x4b, 0x10, 0x05, 0x2a, 0x42, 0x0a, 0x0c, 0x4e,
	...
	0x4e, 0x56, 0x49, 0x44, 0x49, 0x41, 0x5f, 0x50, 0x34, 0x10, 0x05, 0x2a, 0x90, 0x02, 0x0a, 0x0c,
	...
	0x54, 0x59, 0x50, 0x45, 0x5f, 0x42, 0x4f, 0x53, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x09, 0x42, 0x3f,
	0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x2d, 0x72,
